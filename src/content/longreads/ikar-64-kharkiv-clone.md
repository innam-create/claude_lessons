...
Ікар-64 зберігається в колекції музею — саме звідти фотографія вгорі (це власний знімок, а не запозичене зображення). У постійній експозиції машина наразі фізично не виставлена, але вона задокументована в [каталозі клонів](/clones/) поряд з іншими європейськими, українськими та американськими машинами — від чехословацьких Didaktik і Timex зі США до дніпровського Орля.
