...
# (src/content/longreads/self-assembly-soldered-on-the-kitchen-table.md).
...
The key to self-assembly lay in one technical detail. In the genuine Spectrum the heart of the machine was the custom ULA chip — it took on video, sound and input/output (there is more on this in the [breakdown of the architecture](/en/history/what-is-inside-z80-ula-48k/)). The problem is that the ULA was effectively a “black box”: to make sense of it and reproduce it was the hardest part. So many clones took a detour — they abandoned the ULA altogether and reproduced its functions with ordinary logic chips.
