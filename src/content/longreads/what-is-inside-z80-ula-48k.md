...
Функціонально ULA — це «все інше» комп'ютера в одному кристалі. Вона формує відеосигнал для телевізора, опитує клавіатуру, керує введенням-виведенням на касетний магнітофон, звуковим біпером і кольором рамки екрана. Там, де в дорожчих машинах стояли б десятки окремих мікросхем, у Spectrum працює один чип — і саме тому машина коштувала стільки, скільки коштувала.
